    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
      <jet-form-section @submitted="submit">
        ...
        <template #description>
          ...
          quia soluta magni optio labore atque laudantium iusto sunt natus
          architecto, qui aperiam, dolore quas corrupti voluptatum itaque!
          Consequuntur, saepe.
        </template>
        ...
        <template #form>
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <!-- Error -->
            <jet-input-error :message="form.errors.admin_first_name" class="mt-2" />
          </div>
          ...
          <div class="col-span-6 lg:col-span-2">
            ...
            <!-- Error -->
            <jet-input-error :message="form.errors.admin_last_name" class="mt-2" />
          </div>
        ...
        <template #actions>
          ...
          <label class="flex items-center mr-3">
            <jet-checkbox
              name="remember"
              v-model:checked="form.addOtherAdmin"
            />
...
export default {
  ...
  methods: {
    ...
    submit() {
      let url = route("buildingAdmin.store");
